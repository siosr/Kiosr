...
<html lang="zh-CN">
	...
	<link async href="<?php echo themeurl('/main.css')?>?v=272" rel="stylesheet" type="text/css">
	<script async src="<?php echo themeurl('/main.js')?>?v=318"></script>
	</head>
	<body>
		<div id="wrap">
			<div id="backdrop"></div>
			...
			<header id="bar" class="hidden">
				...
				<?php $this->options->dh() ?>
				<div class="nav menu"><?php getExplode($this->options->fl);?></div>
			</header>
			<section id="search">
